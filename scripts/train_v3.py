...
from cough_analysis.v3 import SpectrogramDataset, build_dataset, resolve_device, split_records
...
def main() -> int:
    ...
    train_ids, val_ids, test_ids = split_records(metadata, random_state=args.seed)
    print(
